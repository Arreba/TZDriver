...
namespace TZDriver.Models.Tools.Events
{
    ...
    public class DependencyPropertyChangeEventSource<TPropertyType> : FrameworkElement
    {
        /// <summary>
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register(
                ...
                typeof(DependencyPropertyChangeEventSource<TPropertyType>),
        ...
        {
            var target = (DependencyPropertyChangeEventSource<TPropertyType>)d;
        ...
        #region CTOR
        /// <summary>
        /// Initializes a new instance of the <see cref="DependencyPropertyChangeEventSource{TPropertyType}"/> class.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <param name="propertyName">Name of the property.</param>
        /// <param name="bindingMode">The binding mode.</param>
        public DependencyPropertyChangeEventSource(
