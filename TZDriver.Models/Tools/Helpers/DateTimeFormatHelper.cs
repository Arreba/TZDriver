...
{
    public class DateTimeFormatHelper : IFormatProvider, ICustomFormatter
    {
        ...
        public static string GetWeekDescription(DateTime dt)
        {
            string suffix;
            ...
            return string.Format("{0} {1}{2}", dt.DayOfWeek.ToString().ToUpper(), dt.Day, suffix);
        }
        ...
        public static int GetWeekNumberOfYear(DateTime dateTime)
        {
        ...
        public static int GetIso8601WeekNumberOfYear(DateTime time)
        {
